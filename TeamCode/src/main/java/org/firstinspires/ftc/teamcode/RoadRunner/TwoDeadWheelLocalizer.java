...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 9576.009198068517; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -8025.508109355622; // x position of the perpendicular encoder (in tick units)
    }
