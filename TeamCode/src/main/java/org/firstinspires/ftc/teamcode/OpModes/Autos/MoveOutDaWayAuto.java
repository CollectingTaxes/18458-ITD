...
@Config
@Autonomous
public class MoveOutDaWayAuto extends LinearOpMode {
    ...
    public static double MinAccel = -52.5, MaxAccel = 52.5, WheelVel = 52.5;

    public static Vector2d PRELOAD = new Vector2d(7, 32);
    public static Vector2d FIRSTGRAB = new Vector2d(-48.7, 53);
    public static Vector2d SECONDGRAB = new Vector2d(-36, 37);
    public static Vector2d THIRDGRAB = new Vector2d(-46, 34);
    public static Vector2d HPZONE = new Vector2d(-15, 54);
    public static Vector2d CYCLE = new Vector2d(18, 60.5);
    public static Vector2d PARK = new Vector2d(-40, 60.5);
    public static Vector2d FIRSTSPEC = new Vector2d(20 , 32);
    public static Vector2d SECONDSPEC = new Vector2d(22, 32);
    public static Vector2d THIRDSPEC = new Vector2d(24, 32);
    public static Vector2d FOURTHSPEC = new Vector2d(26 , 32);
    public static Vector2d FIFTHSPEC = new Vector2d(28, 32);
    ...
    public static Pose2d ThirdGrab = new Pose2d(THIRDGRAB, Math.toRadians(205));
