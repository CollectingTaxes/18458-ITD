...
@Config
public final class StrafeChassis {
    public static class Params {
        ...
        public double minProfileAccel = -42.5;
        public double maxProfileAccel = 42.5;
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront = new OverflowEncoder(new RawEncoder(StrafeChassis.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(StrafeChassis.this.leftRear));
            rightBack = new OverflowEncoder(new RawEncoder(StrafeChassis.this.rightRear));
            rightFront = new OverflowEncoder(new RawEncoder(StrafeChassis.this.rightFront));
    ...
    public StrafeChassis(HardwareMap hardwareMap, Pose2d pose) {
