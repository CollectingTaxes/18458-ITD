...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = StrafeChassis.class;
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(StrafeChassis.class)) {
            dvf = hardwareMap -> {
                StrafeChassis md = new StrafeChassis(hardwareMap, new Pose2d(0, 0, 0));

                List<Encoder> leftEncs = new ArrayList<>(), rightEncs = new ArrayList<>();
                List<Encoder> parEncs = new ArrayList<>(), perpEncs = new ArrayList<>();
                if (md.localizer instanceof StrafeChassis.DriveLocalizer) {
                    StrafeChassis.DriveLocalizer dl = (StrafeChassis.DriveLocalizer) md.localizer;
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        StrafeChassis.PARAMS.inPerTick,
                        StrafeChassis.PARAMS.maxWheelVel,
                        StrafeChassis.PARAMS.minProfileAccel,
                        StrafeChassis.PARAMS.maxProfileAccel,
                        ...
                        md.lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(StrafeChassis.PARAMS.kS,
                                StrafeChassis.PARAMS.kV / StrafeChassis.PARAMS.inPerTick,
                                StrafeChassis.PARAMS.kA / StrafeChassis.PARAMS.inPerTick)
                );
            };
