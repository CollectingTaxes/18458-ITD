...
//                               new TrajectorySequenceContainer(drive, BlueFarConstants.Path.OuttakePreLoad.outtakePreLoad)
//                        ),
//
...
//
//                public static class Start { static Pose2dContainer startPose = new Pose2dContainer(-32,61,270);
//            }
//            public static class OuttakePreLoad {
//                public static LineToLinearHeading pathOne = new LineToLinearHeading(1,33, -90);
//                static TrajectorySequenceContainer outtakePreLoad = new TrajectorySequenceContainer(Speed::getBaseConstraints, pathOne);
//
//            }
